...
import { labelOrFallback, labelOrValue, monthlyPlanStatusLabels, monthlyPlanTypeLabels } from '../../../../domain/financeLabels';
            ...
            <tbody>
              {items.map((item) => (
                <tr key={item.itemId}>
                  ...
                  <td>
                    <strong>{labelOrFallback(statusLabel, item.executionStatus, 'Estado no reconocido')}</strong>
