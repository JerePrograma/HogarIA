...
export const previewMonthlyPlanQuickCapture = (profileId: string, payload: QuickCapturePreviewRequest) =>
  http.post<QuickCapturePreviewResponse>(`/profiles/${profileId}/planning/quick-capture/preview`, payload).then(r => r.data);

export const commitMonthlyPlanQuickCapture = (profileId: string, payload: QuickCaptureCommitRequest) =>
  http.post<QuickCaptureCommitResponse>(`/profiles/${profileId}/planning/quick-capture/commit`, payload).then(r => r.data);
