...
export function MonthlyPlanItemsTable({ items, accounts, categories, onConvert, onCancel, onDelete, onUpdate, onMarkPaid, onMarkCollected, pendingActionId, actionError }) {
