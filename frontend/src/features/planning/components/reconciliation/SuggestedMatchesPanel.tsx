...
import { labelOrValue, monthlyPlanTypeLabels, movementTypeLabels } from '../../../../domain/financeLabels';
          ...
          {matches.map((match) => (
            <article key={`${match.itemId}-${match.transactionId}`} className="panel-muted">
              <div className="section-title">
                ...
                <span className="badge-ui badge-ok">Confianza {confidenceLabel[match.confidence] ?? match.confidence}</span>
              </div>
