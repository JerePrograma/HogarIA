...
import { commitBancoProvinciaLoans, previewBancoProvinciaLoans } from '../../../api/bancoProvinciaLoanImportApi';
...
export function BancoProvinciaLoanImportPage() {
  ...
  const [file, setFile] = useState<File | null>(null); const [rows, setRows] = useState<any[]>([]); const [error, setError] = useState<string | null>(null);
